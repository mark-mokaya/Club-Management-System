...
<div id="wrapper">
    ...
    <div id="page-wrapper">
            <div class="row" >
                <div class="col-lg-12">
                    <h4 class="page-header" style="margin-top:10px;color:blue"><span id="clubname_" ></span><span> Club Minutes</span> </h4>
                </div>
                <!-- /.col-lg-12 -->
            </div>
          <span data-placement="top" data-toggle="tooltip" title="Refresh ">
            ...
            <div class="row">
                <div class="col-md-12">
                  <table  class="table table-striped table-bordered table-hover display responsive nowrap" cellspacing="0" width="100%" id="clubminuteslist">
                        <thead>
                            <tr>
...
$('#clubid').on('change', function() 
{
           ...
           document.getElementById('clubname_').innerHTML=clubName;
            ...
            $("#clubminuteslist").dataTable().fnDestroy();//destroy the table and recreate it for every refresh


                    var table=$('#clubminuteslist').DataTable({"iDisplayLength": 10,"lengthMenu": [[10, 25, 50, 100, 200, -1], [10, 25, 50, 100, 200, "All"]],

                    "ajax": {
                    "url":'<?php echo base_url('index.php/ClubController/perclubminutes')?>'+"?clubID="+clubID,
                    "type":"GET",
                    "dataType":"json"},
                    "columns": [
                    ...
                    {"bSortable":false, "aTargets": [0],"sWidth": "5%", "orderable": false},
                      ...
                      {
                        return '<span data-placement="top" data-toggle="tooltip" title="Download Constitution"><a class="btn btn-xs" data-title="View" id="view" href="<?php echo base_url();?>ClubController/download_minutes/'+data+'" ><span class="fa fa-download fa-lg"></span></a></span>&nbsp'; 
                      }
             ...
             $.ajax(
                    {
                        ...
                        success:function(data)
                        {
                            ...
                            location.href="<?php echo base_url('index.php/ClubController/perclubmemberspdf'); ?>"+'?clubID='+feedback;
                        }
                    });
        });
