...
<div id="wrapper">
    ...
    <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="page-header" style="margin-top:10px;color:blue"><span id="clubname_"></span><span> Events</span> </h4>
                </div>
                <!-- /.col-lg-12 -->
            </div>
           ...
           document.getElementById('stateclub').innerHTML="Club";
            ...
            $("#eventslist").dataTable().fnDestroy();//destroy the table and recreate it for every refresh
                 ...
                 var table=$('#eventslist').DataTable({responsive:true,"iDisplayLength": 10,"lengthMenu": [[10, 25, 50, 100, 200, -1], [10, 25, 50, 100, 200, "All"]],
                    ...
                    { "data": "eventDate",responsivePriority: 2 },
                    { "data": "eventVenue" ,responsivePriority: 3},
                    { "data": "startTime" },
                    { "data": "endTime" },
                    { "data": "action" }],
...
$('#clubid').on('change', function() 
{
           ...
           if(clubID!=="All")
             {
                document.getElementById('stateclub').innerHTML="End Time";
              }else
                {
                    document.getElementById('stateclub').innerHTML="Club";
            ...
            $("#eventslist").dataTable().fnDestroy();//destroy the table and recreate it for every refresh
                   ...
                   var table=$('#eventslist').DataTable({responsive:true,"iDisplayLength": 10,"lengthMenu": [[10, 25, 50, 100, 200, -1], [10, 25, 50, 100, 200, "All"]],
                    ...
                    //aoColumnDefs This array allows you to target a specific column, multiple columns, or all columns, using the aTargets property of each object in the array
                    "aoColumnDefs": [
                    {"bSortable":false, "aTargets": [0], "orderable": false,"sWidth": "10%"},
                    {"aTargets": [1], "sWidth": "15%"},
