...
$pdf->SetTitle('Strathmore University Clubs');
$pdf->SetSubject('List of Clubs');
$pdf->SetKeywords('Clubs');

// set default header data
$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, PDF_HEADER_TITLE, "Active Student Clubs\nDownloaded:".date_format( date_create(date('c')), ' j F Y,  g:i A' ), array(0,0,0), array(0,0,0));
