...
<div id="wrapper">
    ...
    <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="page-header" style="margin-top:10px;color:blue"><span><?php  echo $clubname; echo ": Attendance for the meeting held on ";echo $date. " at ". $venue ." from ". $from;?></span><span id="meeting_"></span> </h4>
                </div>
                <!-- /.col-lg-12 -->
            </div>
...
<script>
...

   {
            $("#meetingattendancelist").dataTable().fnDestroy();//destroy the table and recreate it for every refresh
                    ...
                    "ajax": {
                    "url":"<?php echo base_url('index.php/ClubController/viewmeetingattendancelist')?>",
                    "type":"POST",
                    "dataType":"json"},
                    "columns": [
