            ...
            $("#eventattendancelist").dataTable().fnDestroy();//destroy the table and recreate it for every refresh
                  ...
                  "ajax": {
                    ...
                    {"bSortable":false, "aTargets": [0], "orderable": false},
                      ...
                      { 
                        return '<input type="radio" name="status_'+data+'" value="Attending" id="status_'+data+'">&nbsp;&nbsp;Attending &nbsp;&nbsp;<input type="radio" name="status_'+data+'" value="Not Attending" id="status_'+data+'">&nbsp;&nbsp;Not Attending&nbsp;&nbsp'; 
             ...
             $.ajax(//ajax script to post the data without page refresh
                {
                    ...
                    success:function(data)
                    {
                        ...
                        if(data.successful)
                            {
                              $("#attSuccess ").fadeTo(2000, 200).slideUp(500, function(){});
                            ...
                            }else if(data.alreadyadded) 
                                    {
                                        $("#attDuplicate ").fadeTo(2000, 200).slideUp(500, function(){});
                                            ...
                                            {
                                                $("#attNull ").fadeTo(2000, 200).slideUp(500, function(){});
                                            }
                    }
                });
