        ...
        <div id="page-wrapper" >
            ...
            <div class="row" >
                <div class="col-lg-12" style="margin-top:10px;color:blue">
                    <h4 class="page-header"><span><?php  echo $this->session->userdata('clubName'); echo " Event Attendance";?></span></h4>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            ...
            <div class="modal fade" id="attDuplicate" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
              <div class="modal-dialog" role="document">
                  ...
                  <div class="alert alert-danger">
                      <p class="text-center"><strong >Fail:</strong> Attendance for this event already exist!</p>
...
<script>
...

   {
            ...
            $("#eventattendancelist").dataTable().fnDestroy();//destroy the table and recreate it for every refresh
                    ...
                    var table=$('#eventattendancelist').DataTable({paging:false,responsive:true,"iDisplayLength": 10,"lengthMenu": [[10, 25, 50, 100, 200, -1], [10, 25, 50, 100, 200, "All"]],
    ...
    $( "#submit").on('click', function(event)
        {
            ...
            event.preventDefault(event);//prevent auto submit data
             ...
             var table=$('#eventattendancelist').DataTable();
             // var stu_id = ()

            var eventid=$('#event').val();
            var selected = [];

            $('#eventattendancelist input:radio:checked').each(function() {
               var $item = $(this);
             ...
             $.ajax(//ajax script to post the data without page refresh
                {
                    type:"post",
                    url: "<?php echo base_url('index.php/ClubController/eventattendancerecord')?>",
 ...
 $(document).ready(function () 

   {
     ...
     $.ajax(
                {
                    type:"post",
                    url: "<?php echo base_url('index.php/ClubController/eventsdropdown'); ?>",
                    dataType:'json',
