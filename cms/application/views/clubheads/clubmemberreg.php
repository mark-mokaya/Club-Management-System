...
function submitData()
        {
           ...
           var course= $("#clubmemberreg #course").val();
            ...
            $.ajax(//ajax script to post the data without page refresh
                {
                    type:"post",
                    url: "<?php echo base_url('ClubController/clubmemberregistration');?>",
          ...
          var table=$('#clubmemberslist').DataTable();
           ...
           var pid= $("#editclubmemberreg #pid").val();
            ...
            $.ajax(//ajax script to post the data without page refresh
                {
                    type:"post",
                    url: "<?php echo base_url('ClubController/clubmemberupdate');?>",
...
function deleteclubmember(objButton)
{
        ...
        $( "#deleteclubmemberconfirm").on('click', function(event)
            ...
            $.ajax(
                {
                    type:"post",
                    url: "<?php echo base_url('ClubController/deleteclubmember');?>",
                    data:{ pid:pid},
                    dataType:'json',
