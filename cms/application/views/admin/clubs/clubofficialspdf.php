...
$pdf->AddPage('P');//Portrait page format
...
$table .='<th width="10%" style="text-align:center;font-weight:bold">Std. ID</th>';
...
$table .='<th width="15%" style="text-align:center;font-weight:bold">Phone</th>';
...
foreach ($clubofficials as $record) 
{
    ...
    $table .='<th width="15%" >'.$record['telNo'].'</th>';
