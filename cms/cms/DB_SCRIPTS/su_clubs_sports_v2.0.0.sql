...
--
-- Host: 127.0.0.1
-- Generation Time: May 09, 2017 at 03:02 PM
...
--
ALTER TABLE `clubmembers`
  MODIFY `pID` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=207;
--
-- AUTO_INCREMENT for table `clubofficials`
--
ALTER TABLE `clubofficials`
  MODIFY `autoID` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `eventattendance`
  MODIFY `autoID` int(20) NOT NULL AUTO_INCREMENT;
--
