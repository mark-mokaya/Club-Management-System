...
<head>
 ...
 /* Centering td values in datatable*/
    ...
    #officialsnominationlist th
        {
            border-bottom:2px solid;
            border-color: grey;
        }
    #officialsnominationlist
        {
            border-bottom:none;
        }
    #meeting option
...
<div id="wrapper">
        ...
        <div id="page-wrapper" >
         ...
         <div class="row">
                <div class="col-md-12">
                   <table  class="table table-striped table-bordered table-hover display responsive nowrap" cellspacing="0" width="100%"  id="officialsnominationlist">
                        <thead>
                            <tr>
            ...
            <div class="modal fade" id="success" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
              <div class="modal-dialog" role="document">
                  ...
                  <div class="alert alert-info">
                      <p class="text-center"><strong >Success:</strong> Nomination Successful.</p>
            ...
            <div class="modal fade" id="fail" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
              <div class="modal-dialog" role="document">
                  ...
                  <div class="alert alert-danger">
                      <p class="text-center"><strong >Fail:</strong>Nomination Failed!</p>
...
<script>
...

   {
            ...
            $("#officialsnominationlist").dataTable().fnDestroy();//destroy the table and recreate it for every refresh



                    var table=$('#officialsnominationlist').DataTable({paging:false,responsive:true,"iDisplayLength": 10,"lengthMenu": [[10, 25, 50, 100, 200, -1], [10, 25, 50, 100, 200, "All"]],
                    ...
                    {"bSortable":false, "aTargets": [0], "orderable": false},
                      ...
                      "mRender": function ( data, type, full ) 
                        { 
                          return '<input type="radio" name="nominate" value="'+data+'" id="nominate" onclick="nominate(this)">&nbsp;&nbsp;Nominate'; 
                        }
...
function nominate(objButton)
    {
      var table=$('#officialsnominationlist').DataTable();
